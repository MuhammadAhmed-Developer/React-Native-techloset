    ...
    <>
      ...
      <View>
        <Modal style={styles.model} isVisible={isModalVisible}>
          <View style={{ display: 'flex', alignItems: 'flex-end', }}>
            <View style={{ backgroundColor: "#EFEEF0", padding: 6, borderRadius: 100 }} >
              <Icon name='close' size={14} color={'black'} onPress={toggleModal} />
            </View>
          </View>
          <View>
          ...
          <View style={styles.colosparent}>
            <View onPress={applyBorder}>
              <View style={[!selectedColor ? styles.border : styles.borderHide]}>
          ...
          <View>
            <View style={{ borderBottomWidth: 1, marginTop: 15, borderColor: '#EFEEF0' }}></View>
            <Text style={[styles.changeBackground, styles.Extras]}>EXTRAS</Text>
            <View style={styles.parentlist}>
              <View style={{ display: "flex", flexDirection: 'row' }}>
                <IconF style={{ marginRight: 8, marginTop: 1 }} name='clock' size={25} color={'black'} />
                <Text style={styles.remainder}>Set Reminder</Text>
              </View>
              <View >
                <View style={{ display: "flex", flexDirection: 'row' }}>
                  <Text style={styles.leftmenu}>Not set </Text>
                  <IconMa style={{ marginLeft: 3 }} name='arrow-forward-ios' size={10} color={'#827D89'} />
                </View>
              </View>
            </View>
            ...
            <View style={styles.parentlist}>
              <View style={{ display: "flex", flexDirection: 'row' }}>
                <IconF style={{ marginRight: 8 }} name='edit' size={25} color={'black'} />
            ...
            <View style={styles.parentlist}>
              <View style={{ display: "flex", flexDirection: 'row' }}>
                <Icon style={{ marginRight: 8 }} name='tago' size={25} color={'black'} />
                <Text style={styles.remainder}>Give Label</Text>
              </View>
              <View >
                <View style={{ display: "flex", flexDirection: 'row' }}>
                  <Text style={styles.leftmenu}>Not set </Text>
                  <IconMa style={{ marginLeft: 8 }} name='arrow-forward-ios' size={10} color={'#827D89'} />
                </View>
              </View>
            </View>
            ...
            <View style={styles.parentlist}>
              <View style={{ display: "flex", flexDirection: 'row' }}>
                <Icon style={{ marginRight: 8 }} name='check' size={25} color={'black'} />
          ...
          <View style={{ display: "flex", flexDirection: 'row', marginTop: 12 }}>
            <Icon style={{ marginTop: 2, marginRight: 16 }} name='delete' size={16} color={'#CE3A54'} />
      ...
      <View>
        <Modal style={styles.model} isVisible={isModalVisible2}>
          <View style={{ display: 'flex', alignItems: 'flex-end', }}>
            <View style={{ backgroundColor: "#EFEEF0", padding: 6, borderRadius: 100 }} >
              <Icon name='close' size={14} color={'black'} onPress={toggleModal2} />
            </View>
          </View>
          ...
          <TouchableOpacity style={styles.btn}>
            <Text onPress={toggleModal2} style={styles.closebtn}>Close</Text>
          </TouchableOpacity>
          </View>
        </Modal>
      </View>
      ...
      <View style={styles.menuBar}>
        <View style={styles.menuebarIcons}>
          ...
          <View style={styles.icons}>
            ...
            <IconF name="bookmark" size={20} color={'black'} onPress={toggleModal2} />
